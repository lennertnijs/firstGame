...
public class GameObjectTest {
    ...
    public void testSetTexture(){
        TextureRegion newTexture = Mockito.mock(TextureRegion.class);
        gameObject.setTexture(newTexture);
        assertEquals(newTexture, gameObject.getTexture());
    }

    @Test
    public void testSetTextureToNull(){
        assertThrows(NullPointerException.class,
                () -> gameObject.setTexture(null));
    }
