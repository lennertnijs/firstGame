...
public class WeekScheduleTest {
    ...
    public void testToString(){
        String expectedString = "WeekSchedule[DaySchedules={MONDAY=DaySchedule[Activities=[Activity[MapPosition[mapName=world, Position[x=5, y=15]], Time[hours=0, minutes=55], Type=IDLING], Activity[MapPosition[mapName=world, Position[x=10, y=20]], Time[hours=5, minutes=55], Type=IDLING], Activity[MapPosition[mapName=world, Position[x=5, y=15]], Time[hours=10, minutes=55], Type=IDLING]]], TUESDAY=DaySchedule[Activities=[Activity[MapPosition[mapName=world, Position[x=10, y=20]], Time[hours=5, minutes=55], Type=IDLING], Activity[MapPosition[mapName=world, Position[x=5, y=15]], Time[hours=10, minutes=55], Type=IDLING], Activity[MapPosition[mapName=world, Position[x=5, y=15]], Time[hours=15, minutes=55], Type=IDLING]]], WEDNESDAY=DaySchedule[Activities=[Activity[MapPosition[mapName=world, Position[x=5, y=15]], Time[hours=0, minutes=55], Type=IDLING], Activity[MapPosition[mapName=world, Position[x=10, y=20]], Time[hours=5, minutes=55], Type=IDLING]]]}]";
