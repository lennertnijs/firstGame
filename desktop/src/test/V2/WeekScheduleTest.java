...
public class WeekScheduleTest {
    ...
    public void testToString(){
        String expectedString = "WeekSchedule[DaySchedules={MONDAY=DaySchedule[Activities=[Activity[Position[x=5, y=15], Time[hours=0, minutes=55], Type=IDLING, MapName=world], Activity[Position[x=10, y=20], Time[hours=5, minutes=55], Type=IDLING, MapName=world], Activity[Position[x=5, y=15], Time[hours=10, minutes=55], Type=IDLING, MapName=world]]], TUESDAY=DaySchedule[Activities=[Activity[Position[x=10, y=20], Time[hours=5, minutes=55], Type=IDLING, MapName=world], Activity[Position[x=5, y=15], Time[hours=10, minutes=55], Type=IDLING, MapName=world], Activity[Position[x=5, y=15], Time[hours=15, minutes=55], Type=IDLING, MapName=world]]], WEDNESDAY=DaySchedule[Activities=[Activity[Position[x=5, y=15], Time[hours=0, minutes=55], Type=IDLING, MapName=world], Activity[Position[x=10, y=20], Time[hours=5, minutes=55], Type=IDLING, MapName=world]]]}]";
