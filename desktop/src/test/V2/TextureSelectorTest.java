...
public class TextureSelectorTest {
    ...
    public void initialise(){
        ...
        OldAnimation<Texture> oldAnimation1 = new OldAnimation<>(new Texture[]{texture1, texture2, texture3}, 3);
        OldAnimation<Texture> oldAnimation2 = new OldAnimation<>(new Texture[]{texture2, texture3}, 2);
