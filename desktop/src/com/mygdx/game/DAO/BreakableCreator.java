...
public class BreakableCreator {
    ...
    public static List<Breakable> getBreakables(){
        ...
        Breakable stone1 = new Breakable(texture, new Point(50, 50), new Dimensions(30, 20), "main", 500, 250, "Stone", lootTable);
        Breakable stone2 = new Breakable(texture, new Point(350, 350), new Dimensions(30, 20), "main", 500, 250, "Stone", lootTable);
