...
public final class OldAnimation<T> implements IAnimation<T>{

    private final T[] frames;
    private final float duration;

    public OldAnimation(T[] frames, float animationDuration){
    ...
    public boolean equals(Object other){
        if(!(other instanceof OldAnimation<?>))
            return false;
        OldAnimation<?> oldAnimation = (OldAnimation<?>) other;
        return Arrays.equals(frames, oldAnimation.frames) &&
